...
describe('login and delete test t05', () => {
  it('should visit', () => {
    // Login as user 2
    ...
    cy.get("a[data-cy='left-sidebar-CompoundTransactionT05']").click();
    cy.get("input[data-cy='fromAccountEntity']").click();
    cy.get('.q-menu .q-item').first().click();
    cy.get("input[data-cy='udc']").type('test');

    //Delete apo Genikh kai mh diakrito
    ...
    //Delete apo Genikh kai diakrito
    cy.get("div[data-cy='add-tr-item']").click();
    cy.wait(1000);
    cy.get("input[data-cy='dialog-fromAccountEntity']").click();
    cy.get('.q-menu .q-item').first().click();
    ...
    //Delete apo Merikh kai diakrito
    cy.get("div[data-cy='add-tr-item']").click();
    cy.wait(1000);
    ...
    //Delete apo Merikh kai mh diakrito
    cy.get("div[data-cy='add-tr-item']").click();
    cy.wait(1000);
    cy.get("input[data-cy='dialog-fromAccountEntity']").type('01 01').click();
    cy.wait(1000);
