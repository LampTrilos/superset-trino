...
import { getMetaptosiAvl } from 'src/services/items';
...
const { data, isFetching } = useQuery({
  queryKey: ['getMetaptosiAvl', queryPagination, search.value],
  queryFn: () =>
    getMetaptosiAvl(
...
function triggerSearch() {
  queryClient.invalidateQueries({ queryKey: ['getMetaptosiAvl'] });
}
</script>
