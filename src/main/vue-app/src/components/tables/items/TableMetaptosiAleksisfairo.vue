...
import { getMetaptosiAleksisfairo } from 'src/services/items';
...
const { data, isFetching } = useQuery({
  queryKey: ['getMetaptosiAleksisfairo', queryPagination, search.value],
  queryFn: () =>
    getMetaptosiAleksisfairo(
...
function triggerSearch() {
  queryClient.invalidateQueries({ queryKey: ['getMetaptosiAleksisfairo'] });
}
</script>
