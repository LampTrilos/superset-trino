...
import {Antivalistiko, Item, ItemCode, PageResponse} from 'src/services/models';
import { computed, ref } from 'vue';
import {useQuery, useQueryClient} from '@tanstack/vue-query';
import { getMetaptosiSyndesiKinitou } from 'src/services/items';
...
const columns = [
  ...
  {
    name: 'christisSyndesisEponymo',
    required: true,
    label: t('christisSyndesisEponymo'),
    align: 'left',
    field: 'christisSyndesisEponymo',
  },
  {
    name: 'christisSyndesisOnoma',
    required: true,
    label: t('christisSyndesisOnoma'),
    align: 'left',
    field: 'christisSyndesisOnoma',
  },
  {
    name: 'metaptothike',
...
const { data, isFetching } = useQuery({
  queryKey: ['getMetaptosiSyndesiKinitou', queryPagination, search.value],
  queryFn: () =>
    getMetaptosiSyndesiKinitou(
...
function triggerSearch() {
  queryClient.invalidateQueries({ queryKey: ['getMetaptosiSyndesiKinitou'] });
}
</script>
