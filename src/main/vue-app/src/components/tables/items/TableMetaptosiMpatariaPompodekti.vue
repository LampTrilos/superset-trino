...
import {
  getMetaptosiMpatariaPompodekti,
  getMetaptosiParelkomenaPompodekti,
  getMetaptosiPompodektis
...
const columns = [
  ...
  },
  {
    name: 'monteloLektiko',
    required: true,
    label: t('monteloLektiko'),
    align: 'left',
    field: 'markaLektiko',
  },
  {
    name: 'eidosPompoDektiLektiko',
    required: true,
    label: t('eidosPompoDektiLektiko'),
    align: 'left',
    field: 'eidosPompoDektiLektiko',
  },
  {
    name: 'posotita',
    required: true,
...
const { data, isFetching } = useQuery({
  queryKey: ['getMetaptosiMpatariaPompodekti', queryPagination, search.value, metaptothike.value],
  queryFn: () =>
    getMetaptosiMpatariaPompodekti(
...
function triggerSearch() {
  queryClient.invalidateQueries({ queryKey: ['getMetaptosiMpatariaPompodekti'] });
}
</script>
