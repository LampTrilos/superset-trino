...
import {getMetaptosiAvl, getMetaptosiAVlPda} from 'src/services/items';
...
const { data, isFetching } = useQuery({
  queryKey: ['getMetaptosiAVlPda', queryPagination, search.value],
  queryFn: () =>
    getMetaptosiAVlPda(
...
function triggerSearch() {
  queryClient.invalidateQueries({ queryKey: ['getMetaptosiAVlPda'] });
}
</script>
