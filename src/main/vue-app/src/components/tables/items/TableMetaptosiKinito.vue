...
import { getMetaptosiKinito } from 'src/services/items';
...
const { data, isFetching } = useQuery({
  queryKey: ['getMetaptosiKinito', queryPagination, search.value],
  queryFn: () =>
    getMetaptosiKinito(
...
function triggerSearch() {
  queryClient.invalidateQueries({ queryKey: ['getMetaptosiKinito'] });
}
</script>
