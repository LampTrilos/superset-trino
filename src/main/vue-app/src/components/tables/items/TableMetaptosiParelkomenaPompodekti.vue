...
import {getMetaptosiParelkomenaPompodekti, getMetaptosiPompodektis} from 'src/services/items';
...
const columns = [
  ...
  {
    name: 'eidosParelkomenouLektiko',
    required: true,
    label: t('eidosParelkomenouLektiko'),
    align: 'left',
    field: 'eidosParelkomenouLektiko',
  },
  {
    name: 'posotita',
    required: true,
...
const { data, isFetching } = useQuery({
  queryKey: ['getMetaptosiParelkomenaPompodekti', queryPagination, search.value, metaptothike.value],
  queryFn: () =>
    getMetaptosiParelkomenaPompodekti(
...
function triggerSearch() {
  queryClient.invalidateQueries({ queryKey: ['getMetaptosiParelkomenaPompodekti'] });
}
</script>
