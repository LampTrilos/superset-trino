...
import { getMetaptosiPompodektis } from 'src/services/items';
...
const { data, isFetching } = useQuery({
  queryKey: ['getMetaptosiPompodektis', queryPagination, search.value, metaptothike.value, props.eidos],
  queryFn: () =>
...
function triggerSearch() {
  queryClient.invalidateQueries({ queryKey: ['getMetaptosiPompodektis'] });
}
</script>
