...
import {getMetaptosiKinito, getMetaptosiKranosAntivalistiko} from 'src/services/items';
...
const { data, isFetching } = useQuery({
  queryKey: ['getMetaptosiKranosAntivalistiko', queryPagination, search.value],
  queryFn: () =>
    getMetaptosiKranosAntivalistiko(
...
function triggerSearch() {
  queryClient.invalidateQueries({ queryKey: ['getMetaptosiKranosAntivalistiko'] });
}
</script>
