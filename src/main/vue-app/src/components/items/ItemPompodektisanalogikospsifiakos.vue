<template>
    ...
    <q-card style="min-width: 80vw; max-width: 80vw">
      <q-card-section>
        <TableMetaptosiPompodektis
          ...
          :eidos="'pompodektisAnalogikosPsifiakos'"
  ...
  <div class="col-12 col-md-12 q-mb-md">
    <SelectEnum
      ...
      :query-params="'idEidosPompodekti=1,2,3'"
  ...
  <div class="col-12 col-md-12 q-mb-md">
    <q-input
      filled
      v-model="copiedItem.issi"
      :label="t('issi')"
      data-cy="item-issi"
      clearable
      :readonly="!editable"
      :class="restrictions ? ((copiedItem.katastash && [1, 3, 6, 7].includes(copiedItem.katastash.id)) ? 'required' : '') : ''"
      :rules="restrictions ? ((copiedItem.katastash && [1, 3, 6, 7].includes(copiedItem.katastash.id)) ? requiredRule() : null) : null"
      hide-bottom-space
    />
  </div>
  <div class="col-12 col-md-12 q-mb-md">
  ...
  <div class="col-12 col-md-12 q-mb-md">
    <SelectEnumById
      ...
      data-cy="item-idSyndedemenouPompodekti"
      clearable
      :readonly="!editable"
...
import { Pompodektis } from 'src/services/models';
...
function onMetaptosi() {
  ...
  axios
    .get('/api/v1/items-metaptosi/pompodektisAnalogikosPsifiakos/dto/' + selected.id)
    .then((res) => {
