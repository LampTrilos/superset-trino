  ...
  <div class="col-12  q-mb-md">
    <div class="row q-col-gutter-sm">
      ...
      <div v-if="copiedItem.arithmosKykloforiasOchimatos" class="col-4">
        <q-input v-model="validOchima" readonly borderles>
...
import TableMetaptosiAvl from "components/tables/items/TableMetaptosiAvl.vue";
...
function onMetaptosi() {
  ...
  axios
    .get('/api/v1/items-metaptosi/avl/dto/' + selected.id)
    .then((res) => {
