<template>
  ...
  <div class="col-12 col-md-12 q-mb-md">
    <SelectEnum
      ...
      :query-params="'idEidosPompodekti=5&itemCode=' + itemCodeId"
  ...
  <div class="col-12 col-md-12 q-mb-md">
    <InputDate
      :label="t('imerominiaSyntirisis')"
      v-model="copiedItem.imerominiaSyntirisis"
      data-cy="item-imerominiaSyntirisis"
      filled
      clearable
      :readonly="!editable"
      :class="restrictions ? (copiedItem.markaPompodekti && copiedItem.markaPompodekti.inSyntirisi ? 'required' : '') : ''"
      :rules="restrictions ? (copiedItem.markaPompodekti && copiedItem.markaPompodekti.inSyntirisi ? requiredRule() : null) : null"
      hide-bottom-space
    />
  </div>
  <div class="col-12 col-md-12 q-mb-md">
...
function onMetaptosi() {
  ...
  axios
    .get('/api/v1/items-metaptosi/texnikaMesa/dto/' + selected.id)
    .then((res) => {
